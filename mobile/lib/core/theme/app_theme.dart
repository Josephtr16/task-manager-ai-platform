...
class AppColorTokens extends ThemeExtension<AppColorTokens> {
  ...
  factory AppColorTokens.dark() {
    return const AppColorTokens(
      bgBase: AppColors.darkBgMain,
      bgSurface: AppColors.darkBgCard,
      bgRaised: AppColors.darkBgElevated,
      bgOverlay: AppColors.darkBgElevated,
      borderSubtle: AppColors.darkBorder,
  ...
  factory AppColorTokens.light() {
    return const AppColorTokens(
      bgBase: AppColors.lightBgMain,
      bgSurface: AppColors.lightBgCard,
      bgRaised: AppColors.lightBgElevated,
      bgOverlay: AppColors.lightBgElevated,
      borderSubtle: AppColors.lightBorder,
      borderMedium: AppColors.lightBorder,
      borderStrong: AppColors.lightBorder,
